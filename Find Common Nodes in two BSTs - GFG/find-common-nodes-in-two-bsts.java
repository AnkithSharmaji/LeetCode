...
class Solution {
    ...
    public static ArrayList<Integer> findCommon(Node root1, Node root2) {
        ...
        // Perform in-order traversal of both BSTs and store the elements in sorted order.
        inOrderTraversal(root1, list1);
        inOrderTraversal(root2, list2);

        // Merge the two sorted lists while finding common elements.
        int i = 0, j = 0;
    ...
    // Helper function to perform in-order traversal and store elements in sorted order.
